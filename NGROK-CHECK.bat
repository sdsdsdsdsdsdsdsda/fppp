...
net config server /srvcomment:"1111" > out.txt 2>&1
REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" /V EnableAutoTray /T REG_DWORD /D 0 /F > out.txt 2>&1
net user RizFurr kanjut@1234 /add >nul
net localgroup administrators RizFurr /add >nul
...
ICACLS C:\Windows\Temp /grant RizFurr:F >nul
ICACLS C:\Windows\installer /grant RizFurr:F >nul
